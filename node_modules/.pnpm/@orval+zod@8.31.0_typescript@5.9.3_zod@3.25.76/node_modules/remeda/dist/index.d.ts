 ...
 * @hidden
 */
declare function endsWith<T extends string, Suffix extends string>(data: T, suffix: IsNever<EndsWith<T, Suffix>> extends true ? Suffix : never): void;
/**
 ...
 * @category String
 */
declare function endsWith<T extends string, Suffix extends string>(data: T, suffix: string extends Suffix ? never : IsNarrowingUnsound$1<T, Suffix> extends true ? never : Suffix): data is EndsWith<T, Suffix>;
 ...
 * @hidden
 */
declare function endsWith<T extends string, Suffix extends string>(suffix: IsNever<EndsWith<T, Suffix>> extends true ? Suffix : never): (data: T) => void;
 ...
 * @hidden
 */
declare function startsWith<T extends string, Prefix extends string>(data: T, prefix: IsNever<StartsWith<T, Prefix>> extends true ? Prefix : never): void;
/**
 ...
 * @category String
 */
declare function startsWith<T extends string, Prefix extends string>(data: T, prefix: string extends Prefix ? never : IsNarrowingUnsound<T, Prefix> extends true ? never : Prefix): data is StartsWith<T, Prefix>;
 ...
 * @hidden
 */
declare function startsWith<T extends string, Prefix extends string>(prefix: IsNever<StartsWith<T, Prefix>> extends true ? Prefix : never): (data: T) => void;
