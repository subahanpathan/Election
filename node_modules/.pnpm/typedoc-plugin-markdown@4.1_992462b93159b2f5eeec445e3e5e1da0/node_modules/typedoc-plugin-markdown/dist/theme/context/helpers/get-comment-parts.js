                            ...
                            if (typeof part.target === 'string') {
                                ...
                                if (typeof url === 'undefined') {
                                    ...
                                    if (this.options.getValue('validation').rewrittenLink) {
                                        this.theme.application.logger.warn(`"${this.page.model.getFriendlyFullName()}" links to "${part.target.getFriendlyFullName()}", but the link cannot be resolved. TypeDoc requires valid TSDoc declaration references for clickable links.`);
                                    }
                                }
                            }
...
export function getReflectionUrl(context, reflection) {
