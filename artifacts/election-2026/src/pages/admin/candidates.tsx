...
const promisesToString = (promises: string[] | string | undefined) =>
  Array.isArray(promises) ? promises.join("\n") : (promises ?? "");
...
export default function AdminCandidates() {
  ...
  const handleOpenEdit = (candidate: any) => {
    ...
    form.reset({
      ...
      bio: candidate.bio,
      promises: promisesToString(candidate.promises),
